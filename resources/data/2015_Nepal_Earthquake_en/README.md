...
**Raw data consists of (tweet-id, user-id) tuples can be downloaded here: [Nepal_tweet_ids.zip](/resources/data/2015_Nepal_Earthquake_en/raw_data/tweet_ids.zip?raw=true)**
