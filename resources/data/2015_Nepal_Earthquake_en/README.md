...
**Full dataset, which consists of ~4,223,937 tuples (tweet-id, user-id), is available to download: [UNLABELED_NEPAL_DATA_V1.0.zip](/resources/data/2015_Nepal_Earthquake_en/raw_data/unlabeled_nepal_data_lrec16_v1.0.zip?raw=true)**
